...
ex10(X = _ = _ = #xmlel{name = N, children = C, attrs = A}) ->
    #xmlel{name = N, children = C, attrs = A}.

ex11(#xmlel{name = N, children = [#xmlel{name = N1, attrs = A1, children = []}], attrs = A}) ->
    #xmlel{name = N, children = [#xmlel{name = N1, attrs = A1}], attrs = A}.
